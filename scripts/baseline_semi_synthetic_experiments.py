...
if is_jupyter: 
    ...
    parser.add_argument('--out_folder', help='Which folder to write results to', type=str, default='semi_synthetic')
...
# +
policy = whittle_iterative_greedy_policy
name = "iterative_greedy_whittle"

...
do
    ...
    for n_volunteers in 2 4 16
    do 
        tmux send-keys -t match_${seed} "conda activate food; python large_combined_oracle_bandits.py --seed ${seed} --save_name mcts_${n_arms}_${n_volunteers} --n_arms ${n_arms} --volunteers_per_arm ${n_volunteers} | tee ../runs/baseline_matching_seed_${seed}_${n_arms}_${n_volunteers}.txt" ENTER
    done 

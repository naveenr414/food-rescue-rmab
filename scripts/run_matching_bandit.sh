...
do
    ...
    do 
        tmux send-keys -t match_${seed} "conda activate food; python matching_bandit.py --seed ${seed} --match_prob 0.5 --save_name results_${n_arms} --n_arms ${n_arms} | tee ../runs/matching_seed_${seed}_${n_arms}.txt" ENTER
    done 
done 
